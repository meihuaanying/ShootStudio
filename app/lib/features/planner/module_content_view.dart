...
class ModuleContentView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Widget body = switch (module.type) {
      PlanModuleType.theme || PlanModuleType.richText => _richText(
        context,
      ...
      PlanModuleType.crew => _rows(
        context,
        fields: <String>['role', 'who', 'time'],
        labels: <String>['角色', '成员', '时间'],
      ),
      PlanModuleType.budget => _rows(
        context,
  ...
  Widget _palette(BuildContext context) {
    final List<String> colors = (module.data['colors'] as List? ?? <Object?>[])
        .cast<String>();
